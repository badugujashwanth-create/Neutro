...
Check the browser or terminal error first, then verify the documented environment variables and dependent services. Lint failures require lifecycle design decisions; desktop and Supabase components were not built or deployed in this audit.
